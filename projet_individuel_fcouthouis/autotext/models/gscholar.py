...
def get_links(html, outformat):
    ...
    if outformat == FORMAT_BIBTEX:
        ...
        refre = re.compile(
            r'<a href="https://scholar.googleusercontent.com(/scholar\.enw\?[^"]*)"')
    elif outformat == FORMAT_REFMAN:
        refre = re.compile(
            r'<a href="https://scholar.googleusercontent.com(/scholar\.ris\?[^"]*)"')
    elif outformat == FORMAT_WENXIANWANG:
        refre = re.compile(
            r'<a href="https://scholar.googleusercontent.com(/scholar\.ral\?[^"]*)"')
    elif outformat == FORMAT_APA:
        refre = re.compile(
            r'<a href="https://scholar.googleusercontent.com(/scholar\.apa\?[^"]*)"')
...
print(query('The Convolution Neural Network for automatic objects detection in Earth satellite imagery', 6))
